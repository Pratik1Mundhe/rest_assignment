"""
Django settings for rest_assignment project.
...
ALLOWED_HOSTS = [
    "rest-assignment-prod.apigateway.in",
    "rest-assignment-alpha.apigateway.in",
    "rest-assignment-beta.apigateway.in",
    "rest-assignment-gamma.apigateway.in",
    "rest-assignment-staging.apigateway.in",
    "127.0.0.1",
    "localhost"
]

ROOT_URLCONF = 'rest_assignment.urls'

CSRF_COOKIE_SECURE = False

WSGI_APPLICATION = 'rest_assignment.wsgi.application'
...
LOGGING = {
    ...
    'formatters': {
        ...
        'console': {
            'format': "[%(request_id)s] [rest_assignment - "+os.environ.get("STAGE", "local")+
...
# ****************** App Source Config ******************
REST_ASSIGNMENT_SOURCE = "rest-assignment-source"
...
# django-oauth-toolkit (https://github.com/jazzband/django-oauth-toolkit/blob/master/CHANGELOG.md#200-2022-04-24)
PKCE_REQUIRED = False